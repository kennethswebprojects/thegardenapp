...
var place,
    url;
if (!location.hash) {
    place = 'Ireland/Leinster/Dublin';
    place = 'Ireland/Munster/Skibbereen';
    place = 'Ireland/Connacht/Galway';
...
$.ajax({
    dataType: 'xml',
    url: url === 'https://www.yr.no/place/Ireland/Leinster/Dublin/forecast_hour_by_hour.xml' ?
